# WKR macOS 0.7.0 — 配列v1.1対応の保存ソース
...
元のv0.7.0の変換テストに、旧設定・未対応CLI・排他制御の検査を加え、自動検証とビルドを行っています。この保存版での実機入力は未確認です。新しくv2を使う場合は[WKR macOS Public 0.8.0-public.beta.5](https://github.com/yuhkis/wkr-macos/releases/tag/v0.8.0-public.beta.5)を参照してください。
