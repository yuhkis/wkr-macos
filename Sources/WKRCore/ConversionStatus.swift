...
///
/// Kept in the target the tests can import so each recovery instruction is
/// checked against its gate state and holder liveness.
///
...
public enum ConversionStatusText {
    ...
    public static func detailLines(_ content: ConversionMenuContent) -> [String] {
        ...
        case .converting, .stopping, .paused:
            return []
