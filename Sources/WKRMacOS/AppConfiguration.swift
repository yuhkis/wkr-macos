...
struct AppConfiguration {
    ...
    static func parse(
        ...
        var inputSourceID: String? = "com.apple.inputmethod.Kotoeri.RomajiTyping.Japanese"
        var inputModeID: String? = "com.apple.inputmethod.Japanese"
        var modeName = "prefix"
        ...
        // `--flag=value` also accepts the documented long options. Unknown
        // long options are rejected before any action starts. Single-dash
        // arguments are reserved for macOS launch arguments such as `-psn_…`.
