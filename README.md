...
**公開準備版: 0.8.0-public.beta.4 / 配列: 2.0.0-beta.1 / 練習: 0.1.0**。配列は233規則です。Pの短縮形はベータで評価中です。
...
- [検証記録](docs/verification.md)・[残件](docs/roadmap.md)・[Release文案](docs/release-0.8.0-public.beta.4.md)
- [公開作業規約](AGENTS.md)
